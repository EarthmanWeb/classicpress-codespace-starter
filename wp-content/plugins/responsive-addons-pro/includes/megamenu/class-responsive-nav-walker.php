<?php
/**
 * Starting new Responsive_Nav_Walker class.
 *
...
class Responsive_Nav_Walker {
	...
	public function add_custom_fields( $id, $item, $depth, $args ) {
		...
		<p class="description description-wide">
			...
			<?php esc_html_e( 'Mega Menu Settings', 'responsive-addons-pro' ); ?>
				</a>
			</div>
		</p>
			<?php
	...
	public function edit_walker() {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . '/megamenu/class-walker-nav-menu-edit-custom.php';
	...
	public function responsive_nav_menu_arguments() {
		...
		return array(
			...
			'walker'         => new Responsive_Custom_Nav_Walker(),
		);
	}
	...
	public function enqueue_frontend_scripts() {
		...
		if ( 'on' === get_option( 'rpo_megamenu_enable' ) ) {
			if ( $this->is_megamenu_meta_active() ) {
				wp_enqueue_script( 'navigation-pro-scripts', $js_gen_path . 'navigation-pro.js', array( 'jquery', 'responsive-addons-pro' ), RESPONSIVE_ADDONS_PRO_VERSION, true );
			...
			wp_enqueue_script( 'responsive-mega-menu', $js_gen_path . 'mega-menu.js', array( 'jquery', 'responsive-addons-pro' ), RESPONSIVE_ADDONS_PRO_VERSION, true );
		}
	}
	...
	public function enqueue_frontend_styles() {
		if ( 'on' === get_option( 'rpo_megamenu_enable' ) && $this->is_megamenu_meta_active() ) {
			wp_enqueue_style( 'responsive-pro-mega-menu-frontend-style', plugin_dir_url( __FILE__ ) . 'assets/megamenu-frontend.css', array(), RESPONSIVE_ADDONS_PRO_VERSION );
		}
		wp_enqueue_style( 'responsive-pro-mega-menu-style', plugin_dir_url( __FILE__ ) . 'assets/megamenu.css', array(), RESPONSIVE_ADDONS_PRO_VERSION );
	}
	...
	public function enqueue_backend_css() {
		...
		wp_enqueue_style( 'responsive-pro-mega-menu-style', plugin_dir_url( __FILE__ ) . 'assets/menus.css', array( 'wp-components', 'dashicons' ), RESPONSIVE_ADDONS_PRO_VERSION );
