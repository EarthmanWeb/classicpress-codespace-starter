...
if ( ! function_exists( 'pagination_callbacks' ) ) {
	/**
	 * Function for sanitizing
	 */
	function pagination_callbacks() {
...
if ( ! function_exists( 'pagination_trigger' ) ) {
	function pagination_trigger() {
		$shop_scroll_style = get_theme_mod( 'shop_pagination', 'default' );
...
if ( ! function_exists( 'load_more_callback' ) ) {
...
if ( ! function_exists( 'responsive_pro_separator_control' ) ) {
	/**
	 * [responsive_pro_separator_control description].
	 *
	 ...
	 */
	function responsive_pro_separator_control( $wp_customize, $element, $label, $section, $priority, $active_call = null ) {
