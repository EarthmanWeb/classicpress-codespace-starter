...
if ( ! class_exists( 'Responsive_Addons_Pro_Woocommerce_Shop_Pagination' ) ) :
	 ...
	 * Footer Customizer Options
	 */
	class Responsive_Addons_Pro_Woocommerce_Shop_Pagination {
		/**
		 * Setup class.
		 *
		 * @since 1.0
		...
		public function customizer_options( $wp_customize ) {
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'class-responsive-woocommerce-ext.php';

			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'partials/class-responsive-customizer-ext-woocommerce-partials.php';
			$theme = wp_get_theme();
				...
				*/
				...
				$wp_customize->add_control(
					new Responsive_Customizer_Select_Control(
						...
						'shop_pagination_style',
						array(
							'active_callback' => 'pagination_callbacks',
				...
				$wp_customize->add_control(
					new Responsive_Customizer_Select_Control(
						...
						'shop-infinite-scroll-event',
						array(
							'active_callback' => 'pagination_trigger',
				...
				$wp_customize->add_control(
					'shop-load-more-text',
					array(
						'active_callback' => 'load_more_callback',
...
return new Responsive_Addons_Pro_Woocommerce_Shop_Pagination();
