...
if ( ! class_exists( 'Responsive_Addons_Pro_Sticky_Header_Customizer' ) ) :
	/**
	 * Footer Customizer Options
	 */
	class Responsive_Addons_Pro_Sticky_Header_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			*/
			if ( 'Responsive' === $theme->name || 'Responsive' === $theme->parent_theme ) {
				...
				responsive_addons_checkbox_control( $wp_customize, 'disable_sticky_header_mobile_menu', $disable_sticky_header_mobile_menu_label, 'responsive_header_sticky_menu_layout', 25, 0, null );

				// Different Logo For Transparent Header.
				$sticky_header_logo_option_label = __( 'Different Logo For Sticky Header', 'responsive' );
				responsive_addons_checkbox_control( $wp_customize, 'sticky_header_logo_option', $sticky_header_logo_option_label, 'responsive_header_sticky_menu_layout', 30, 0, null );
				...
				responsive_addons_separator_control( $wp_customize, 'sticky_header_color_separator', $sticky_header_color_separator_label, 'responsive_header_sticky_menu_layout', 50, null );

				$sticky_header_background_label = __( 'Background Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_background', $sticky_header_background_label, 'responsive_header_sticky_menu_layout', 100, '' );

				$sticky_header_site_title_color_label = __( 'Site Title Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_site_title', $sticky_header_site_title_color_label, 'responsive_header_sticky_menu_layout', 110, '' );

				$sticky_header_site_title_hover_color_label = __( 'Site Title Hover Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_site_title_hover', $sticky_header_site_title_hover_color_label, 'responsive_header_sticky_menu_layout', 120, '' );

				$sticky_header_text_color_label = __( 'Site Tagline Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_text', $sticky_header_text_color_label, 'responsive_header_sticky_menu_layout', 120, '' );

				$sticky_menu_background_color_label = __( 'Menu Background Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_menu_background', $sticky_menu_background_color_label, 'responsive_header_sticky_menu_layout', 120, '', null );

				// Active Menu Color.
				$sticky_menu_border_color_label = __( 'Active Menu Background Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_active_menu_background', $sticky_menu_border_color_label, 'responsive_header_sticky_menu_layout', 120, '', null );

				// Link Color.
				$sticky_menu_link_color_label = __( 'Menu Item Link Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_menu_link', $sticky_menu_link_color_label, 'responsive_header_sticky_menu_layout', 120, '' );

				// Link Hover Color.
				$sticky_menu_link_hover_color_label = __( 'Menu Item Link Hover Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_menu_link_hover', $sticky_menu_link_hover_color_label, 'responsive_header_sticky_menu_layout', 120, '' );

				// Sub Menu Background Color.
				$sticky_header_sub_menu_background_color_label = __( 'Sub Menu Background Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_sub_menu_background', $sticky_header_sub_menu_background_color_label, 'responsive_header_sticky_menu_layout', 120, '' );

				// Sub Menu Link Color.
				$sticky_sub_menu_link_color_label = __( 'Sub Menu Item Link Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_sub_menu_link', $sticky_sub_menu_link_color_label, 'responsive_header_sticky_menu_layout', 120, '' );

				// Sub Menu Link Hover Color.
				$sticky_sub_menu_link_hover_color_label = __( 'Sub Menu Item Link Hover Color', 'responsive' );
				responsive_addons_color_control( $wp_customize, 'sticky_header_sub_menu_link_hover', $sticky_sub_menu_link_hover_color_label, 'responsive_header_sticky_menu_layout', 120, '' );
			}
		}
		...
		public function customize_preview_init() {
			$path = plugin_dir_url( __FILE__ ) . '../assets/js/customize-preview.js';
			wp_enqueue_script( 'responsive-customize-preview', $path, array( 'customize-preview' ), '1.1', true );
			wp_enqueue_style( 'responsive-customize-preview', plugin_dir_url( __FILE__ ) . '../../css/style.css', false, RESPONSIVE_ADDONS_PRO_VERSION );
...
return new Responsive_Addons_Pro_Sticky_Header_Customizer();
