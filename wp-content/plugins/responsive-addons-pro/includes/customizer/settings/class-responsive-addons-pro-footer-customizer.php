...
if ( ! class_exists( 'Responsive_Addons_Pro_Footer_Customizer' ) ) :
	/**
	 * Footer Customizer Options
	 */
	class Responsive_Addons_Pro_Footer_Customizer {
...
return new Responsive_Addons_Pro_Footer_Customizer();
