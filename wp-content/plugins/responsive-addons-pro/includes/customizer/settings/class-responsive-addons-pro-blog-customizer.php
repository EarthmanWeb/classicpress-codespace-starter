...
if ( ! class_exists( 'Responsive_Addons_Pro_Blog_Customizer' ) ) :
	/**
	 * Blog Customizer Options
	 */
	class Responsive_Addons_Pro_Blog_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_addons_radio_button_control( $wp_customize, 'blog_layout_options', $blog_layout_label, 'responsive_blog_layout', 10, 'blog-layout-1', $blog_layout_choices );
			...
			responsive_addons_checkbox_control( $wp_customize, 'date_box_toggle', $date_box_label, 'responsive_blog_layout', 10, 0 );
...
return new Responsive_Addons_Pro_Blog_Customizer();
