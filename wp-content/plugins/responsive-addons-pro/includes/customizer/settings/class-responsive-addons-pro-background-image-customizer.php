...
if ( ! class_exists( 'Responsive_Addons_Pro_Background_Image_Customizer' ) ) :
	/**
	 * Footer Customizer Options
	 */
	class Responsive_Addons_Pro_Background_Image_Customizer {
...
return new Responsive_Addons_Pro_Background_Image_Customizer();
