...
if ( ! function_exists( 'is_pro_version_greater' ) ) {
	/**
	 * Verify if the version of responsive pro is greater or not.
	 *
	 * @since 2.6.4
	 */
	function is_pro_version_greater() {
...
if ( ! function_exists( 'custom_theme_styles' ) ) {
	...
	function custom_theme_styles() {
		...
		if ( is_pro_version_greater() && ! is_responsive_version_greater() ) {
		...
		if ( is_pro_version_greater( 'responsive-pro' ) && ! is_responsive_version_greater() ) {
			if ( 'on' === get_option( 'rpro_colors_backgrounds_enable' ) ) {
...
add_action( 'wp_enqueue_scripts', 'custom_theme_styles', 99 );
