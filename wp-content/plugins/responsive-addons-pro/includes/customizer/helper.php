...
if ( ! function_exists( 'menu_search_icon' ) ) {
...
if ( ! function_exists( 'responsive_addons_text_control' ) ) {
	/**
	 * [responsive_addons_text_control description]
	 *
	 * @param  [type] $wp_customize [description].
	 * @param  [type] $element      [description].
	 * @param  [type] $label        [description].
	 ...
	 * @return void               [description].
	 */
	function responsive_addons_text_control( $wp_customize, $element, $label, $section, $priority, $default, $active_call = null, $sanitize_function = 'sanitize_text_field', $type = 'text', $transport = 'refresh' ) {
...
add_action( 'init', 'register_woo_cart_shortcodes' );

if ( ! function_exists( 'register_woo_cart_shortcodes' ) ) {
	/**
	 * Register woo cart shortcodes
	 */
	function register_woo_cart_shortcodes() {
		// Register Shortcode returns cart item count.
		add_shortcode( 'responsive_woo_cart_items', 'woo_cart_items_count_function' );
		// Register Shortcode returns total.
		add_shortcode( 'responsive_woo_total_cart', 'woo_cart_total_function' );
		// Register Shortcode returns total.
		add_shortcode( 'responsive_woo_free_shipping_left', 'woo_free_shipping_shortcode' );
	}
}

if ( ! function_exists( 'woo_cart_items_count_function' ) ) {
	/**
	 * Shortcode returns cart item count
	 */
	function woo_cart_items_count_function() {
...
if ( ! function_exists( 'woo_cart_total_function' ) ) {
	/**
	 * Shortcode returns cart total
	 */
	function woo_cart_total_function() {
		if ( ! class_exists( 'WooCommerce' )
				|| is_admin() ) {
			return;
		}
...
if ( ! function_exists( 'responsive_distraction_free_woocommerce' ) ) {
	/**
	 * [responsive_distraction_free_woocommerce description]
	 *
