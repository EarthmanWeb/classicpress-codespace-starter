 ...
 * Responsive Pro Blog Markup
 */
if ( ! class_exists( 'Responsive_Pro_Blog_Markup' ) ) :

	/**
	 * Responsive Pro Blog Markup
	 */
	class Responsive_Pro_Blog_Markup {
		...
		public function responsive_pro_pagination_infinite_enqueue() {
			wp_enqueue_script( 'responsive-pagination-infinite', plugin_dir_url( __FILE__ ) . '../../public/js/pagination-infinite.js', array( 'jquery' ), '3.17.2', true );
...
Responsive_Pro_Blog_Markup::get_instance();
